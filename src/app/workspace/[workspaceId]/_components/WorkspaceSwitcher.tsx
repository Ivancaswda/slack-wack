...
const WorkspaceSwitcher = () => {
    ...
    return (
            <DropdownMenu>
                <DropdownMenuTrigger>
                        <Button className='size-9 relative overflow-hidden bg-[#ABABAD] hover:bg-[#ABABAD]/80 transition text-slate-800 font-semibold text-xl'>
                            {workspaceLoading ? <Loader2Icon className='size-5 animate-spin shrink-0'/> : workspace?.name.charAt(0).toUpperCase()}
                        </Button>
                </DropdownMenuTrigger>
